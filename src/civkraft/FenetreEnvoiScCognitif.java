...
public class FenetreEnvoiScCognitif extends JFrame implements MouseListener{
	...
	public FenetreEnvoiScCognitif(AgentAddress ka, Client d){
		...
		explications = new JLabel("<html><center>Veuillez sélectionnez le schéma cognitif <br> que vous désirez envoyer au serveur d'adresse <br>" + ka +"</center></html>",JLabel.CENTER);

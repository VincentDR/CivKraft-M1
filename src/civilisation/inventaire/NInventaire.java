...
public class NInventaire implements Serializable{

	HashMap<String,HashMap<Integer, Integer>> listeObjets; //String -> Type d'objet , Int1 -> Qualit�, Int2 -> nombre
	Humain h;
	int weight;
	...
	public int possede(Objet o) // retourne le nombre d'objets poss�d�s d'un m�me type, quelque soit sa qualit�
	{
            
		if(listeObjets.containsKey(o.getNom()))
		{
			int retour = 0;
			for(int i : listeObjets.get(o.getNom()).values())
			{
				retour += i;
			}
	...
	public int possede(Objet o, Integer qualite) // retourne le nombre d'objets poss�d�s d'un m�me type, de m�me qualit�
	{

...
public class SchemaCognitif implements Cloneable, Serializable {
	...
	{
		// ajout automatique a la liste gï¿½nï¿½rale
	...
	public SchemaCognitif clone() throws CloneNotSupportedException {
	    ...
	    // On clone les attributs cloneable
      	...
      	/**
      	 * Le clonage n'est pas possible liste par liste à l'arrache
      	 * Il faut cloner les éléments de bases (cognitons, plans et groups) puis modifier les liens pour les rediriger
      	 * vers les éléments clonés et non pas cloner chaque élément en parcourant les liens (récursion quasi infinie et
      	 * dupliquant les éléments plusieurs dizaines de fois)
      	 */
      ...
      //	System.out.println("Plans clonés : " + plansClones);      	
      	...
      	//System.out.println("Groups clonï¿½s : " + groupsClones);
	...
	/**
	 * Renvoie le cogniton non cloné équivalent à celui cloné afin de créer les nouveaux liens
	 */
	...
	/**
	 * Renvoie le cogniton cloné équivalent à celui non cloné afin de créer les nouveaux liens
	 */
	...
	/**
	 * Renvoie le plan cloné équivalent à celui non cloné afin de créer les nouveaux liens
	 */

...
public class L_IsMyAmenagementHere extends LAction
{
	...
	public Action effectuer(Humain h)
	{
		...
		if (h.getPatch().isMarkPresent(objet.getNom().toLowerCase().toString()) && h.getBuildings().containsKey(objet.getNom()))

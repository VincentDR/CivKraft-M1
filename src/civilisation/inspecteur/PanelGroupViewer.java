...
public class PanelGroupViewer extends JPanel{
	...
	JLabel titre = new JLabel(I18nList.CheckLang("Groups"));
	...
	public void afficherPopup(MouseEvent e) {
		...
		popup = new JPopupMenu(I18nList.CheckLang("Groups"));
		
		JMenuItem showInWorldViewer = new JMenuItem(I18nList.CheckLang("Show in world view"));

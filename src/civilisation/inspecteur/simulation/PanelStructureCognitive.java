...
public class PanelStructureCognitive extends JJPanel{
	...
	*/	
	...
	public void animate(){
		...
		// sinon on garde le compteur à 0
		else{
			compteur=0;
		}		
	}
	...
	public void afficherPopupCogniton(MouseEvent e , GCogniton c){
		...
		// On supprime les panelModifPoidsLI présent
	...
	*/
	...
	public void enleverPanelEdit()
	{
		...
		// On réanime les indicateurs de poids des liens
	...
	// Methode qui met les gItem (gCogniton et gPlan) au dernier plan, pour pas qu'il genent à l'affichage

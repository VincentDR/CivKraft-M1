...
public class PanelMindData extends JPanel{
	...
	public PanelMindData(Humain h) {
		...
		chartPlanWeight = createChart(dataPlanWeight, I18nList.CheckLang("Plans weight"));
        ...
        chartCogniWeight = createChart(dataCogniWeight, I18nList.CheckLang("Cogni weight"));

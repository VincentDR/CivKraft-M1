	  ...
	  public Object[][] getContents() { 
		  ...
		  static final Object[][] contents = { 
			...
			//civilisation.inspecteur
	  			...
	  			{"Phero map : ","Phero map : "},
	  			{"Show specific group and role :","Voir le groupe et le rôle spécifique :"},
	  			{"Aucun patch selectionne", "Aucun patch sélectionne"},
	  			{"Attribut","Attribut"},
	  			{"Valeur", "Valeur"},
	  			//PanelPerformances
	  			{"OS : ","OS : "},
	  		...
	  		//civilisation.inspecteur.simulation.dialogues
	  			...
	  			{"Cogniton hues : ","Teintes Cogniton : "},
	  			...
	  			{"Auto-Plan","Auto-Plan"},
	  			{"Every agents will run this plan every tick if this box is checked. You could use this features to create automatic cognitons transmissions," ,"Tous les agents seront exécuter sur ce plan a chaque tick si cette case est cochée. Vous pouvez utiliser cette fonctionnalité pour créer automatiques cognitons transmissions,"},
